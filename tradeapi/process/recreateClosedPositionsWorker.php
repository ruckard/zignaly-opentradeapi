...
global $continueLoop;
$processName = 'recreateClosedPositionsWorker';
...
$halt = (isset($argv['1'])) ? $argv['1'] : false;
$queueName = 'closedPositionsQueue';
...
do {
    try {
        ...
        $message = RecreateClosedPositions::fromJson($popMember[1]);
        try {
            $closedPositionsService->storeClosedPositions($message->userId, $message->internalExchangeId, 500);
            $Monolog->sendEntry(
                'info', 
                sprintf(
